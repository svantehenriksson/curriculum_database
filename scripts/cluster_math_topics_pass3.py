...
RULES: list[tuple[str, str, str]] = [
    ...
    ("math.number.fractions_decimals", "high", "murtol|braktal|desimaal|decimaltal"),
    ("math.number.basic_operations", "high", "peruslaskutoimit|luvut ja laskutoimitukset|rakneoperation|raknesattens ordningsfoljd|rationella tal"),
    ...
    ("math.algebra.expressions", "high", "lauseke|uttryck|polynom|monomi|kirjainlask"),
    ("math.algebra.variables", "high", "muuttuj|variabel|obekant"),
    ("math.algebra.equations_linear", "high", "ensimmaisen asteen yhta|forstagradsekvation|lineaarinen yhta|yhtalonratkaisu|losa ekvationer"),
    ("math.algebra.equation_systems", "high", "yhtaloryh|ekvationssystem"),
    ...
    ("math.geometry.angles_lines", "high", "kulma|vinkel|suora|raet linje|rat linje|geometrian kasitte|geometrins begrepp"),
    ...
    (
        "math.digital_tools",
        "medium",
        "tieto ja viestintateknolog|informations och kommunikationsteknik|digit|geogebra|matematiikkaohjelmisto|datorprogram|kalkylprogram",
    ),
    ("math.programming_algorithmic", "medium", "ohjelmoin|programmer|algoritm"),
    ...
    ("math.modeling_application", "medium", "muissa?ki?n oppiaineissa|omgivande samhallet|eri aloilla|mathematik i vardagen|matematik inom det egna intresseomradet"),
    ("math.calculation_workflow", "medium", "systematiskt|laskeutmis|utrakningar systematiskt"),
    ("math.mathematical_communication", "medium", "matemaattiseen ilmaisuun|matematiskt korrekt satt"),
    ("math.data_literacy", "medium", "keraamaan j[aä]sent[aä]m[aä][aä]n ja analysoimaan tietoa|soka strukturera och analysera information|samla strukturera och analysera information"),
    ("math.critical_evaluation", "medium", "kriittis|kritiskt|riktigheten av ett pastaende"),
    ("math.self_regulation", "low", "asettaa tavoitte|ansvar for att stalla upp mal|utvardering av den egna arbetsprocessen|ottamaan vastuuta matematiikan oppimisesta|ta ett storre ansvar for sin egen inlarning"),
    ("math.creative_thinking", "low", "luov|kreativt tankande|skapa nytt"),
    ("math.identity_attitude", "low", "minakuva|sjalvbild|itseluottamus|lita pa sig"),
    ("math.reasoning_logic", "medium", "ajattelun taidot ja menetelmat"),
    ("math.algebra.expressions", "high", "s3 algebra"),
    ("math.geometry.angles_lines", "high", "s5 geometria"),
]
